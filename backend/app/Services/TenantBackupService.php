...
class TenantBackupService
{
    ...
    public const TENANT_TABLES = [
        ...
        'store_order_items', 'store_orders', 'wishlist_items',
        'store_collection_products', 'store_collections', 'store_layout_sections', 'store_settings',
        'cms_media', 'cms_pages', 'blog_posts', 'faq_entries',
        'landing_features', 'landing_reviews', 'newsletter_subscribers',
