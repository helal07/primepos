    ...
    public static function all(): array
    {
        return [
            ...
            'products' => [
                ...
                'sort'         => ['name', 'sku', 'created_at', 'updated_at', 'selling_price', 'stock_quantity'],
            ...
            'stock_adjustments' => [
                ...
                'module'  => 'inventory',
                'filters' => ['product_id', 'variation_id', 'warehouse_id', 'adjustment_type'],
                'sort'    => ['created_at'],
                'default_sort' => '-created_at',
            ...
            'accounts' => [
                ...
                'module'       => 'accounting',
                'filters'      => ['account_type', 'parent_id', 'is_active'],
            ...
            'transactions' => [
                ...
                'module'       => 'accounting',
                'filters'      => ['account_id', 'type', 'reference_no', 'journal_entry_id', 'transaction_date'],
            ...
            'journal_entries' => [
                ...
                'module'       => 'accounting',
                'filters'      => ['status', 'entry_date', 'reference_no'],
                'sort'         => ['entry_date', 'created_at'],
                'default_sort' => '-created_at',
                'search'       => ['reference_no', 'description'],
                'with'         => ['lines'],
                'max_per_page' => 500,
            ],
            'journal_entry_lines' => [
            ...
            'expenses' => [
                ...
                'module'       => 'expenses',
                'filters'      => ['category_id', 'sub_category_id', 'warehouse_id', 'account_id', 'payment_status', 'expense_date'],
                'sort'         => ['expense_date', 'created_at', 'amount'],
                'default_sort' => '-expense_date',
                'search'       => ['reference_no', 'notes', 'contact_name'],
            ...
            'installment_customers' => [
                ...
                'sort'         => ['created_at'],
                'default_sort' => '-created_at',
                'search'       => ['guarantor_name', 'guarantor_mobile', 'nid'],
                'with'         => ['customer'],
                'max_per_page' => 500,
            ],
            'installment_sales' => [
            ...
            // ===== Stage 9j — additional admin / module tables =====
            'sms_plans' => [
                'model'        => Models\SmsPlan::class,
                'module'       => 'saas',
                'filters'      => ['is_active'],
                'sort'         => ['price', 'sort_order', 'created_at'],
                'default_sort' => 'price',
                'max_per_page' => 200,
            ],
            'sms_providers' => [
            ...
            'sms_purchases' => [
                ...
                'module'       => 'saas',
                'filters'      => ['tenant_id', 'plan_id', 'status'],
            ...
            'sitemap_entries' => [
                'model'        => Models\SitemapEntry::class,
                'module'       => 'cms',
                'filters'      => ['is_active'],
                'sort'         => ['url', 'priority'],
                'default_sort' => 'url',
            ...
            'shipment_status_history' => [
                'model'        => Models\ShipmentStatusHistory::class,
                'module'       => 'sales',
                'filters'      => ['shipment_id', 'status'],
                'sort'         => ['created_at'],
                'default_sort' => '-created_at',
                'max_per_page' => 1000,
            ],
            ...
            'tenant_payments' => [
                'model'        => Models\TenantPayment::class,
                'module'       => 'saas',
                'filters'      => ['tenant_id', 'package_id', 'status', 'gateway'],
                'sort'         => ['created_at', 'paid_at'],
                'default_sort' => '-created_at',
                'max_per_page' => 500,
            ],
            'tenant_notifications' => [
                'model'        => Models\TenantNotification::class,
                'module'       => 'settings',
                'filters'      => ['tenant_id', 'read_at', 'type', 'channel'],
                'sort'         => ['created_at'],
                'default_sort' => '-created_at',
                'with'         => ['tenant'],
                'max_per_page' => 500,
            ...
            'product_group_prices' => [
                ...
                'module'       => 'inventory',
                'filters'      => ['product_id', 'variation_id', 'selling_price_group_id'],
                'sort'         => ['product_id'],
            ...
            'activity_log' => [
                ...
                'module'       => 'settings',
                'filters'      => ['causer_id', 'event', 'subject_type', 'subject_id'],
                'sort'         => ['created_at'],
                'default_sort' => '-created_at',
                'max_per_page' => 500,
            ],
            ...
            'customer_groups' => [
                ...
                'module'       => 'contacts',
                'filters'      => ['is_active', 'price_group_id'],
                'sort'         => ['name', 'created_at'],
                'default_sort' => 'name',
                'search'       => ['name'],
                'max_per_page' => 500,
