...
import { Users, Package, CreditCard, Globe, Ban, TrendingUp, DollarSign } from "lucide-react";
...
export default function AdminDashboard() {
  ...
  const cards = [
    ...
    { title: "Trial", value: trialTenants, icon: Users, gradient: "from-amber-600 to-amber-800", path: "/admin/tenants" },
    ...
    { title: "CMS", value: "Manage", icon: Globe, gradient: "from-cyan-600 to-cyan-800", path: "/admin/cms" },
  ];
